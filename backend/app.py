...
engine = create_engine(os.environ["DATABASE_URL"], pool_pre_ping=True, pool_size=5)

SECRET_KEY = os.getenv("SECRET_KEY", "cb2a1f2a23921e96d3570d83082763beffb231cbb9ed0084238972d134c26f01")
